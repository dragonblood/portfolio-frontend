  ...
  return (
    <div className="nav fixed">
      <div className="main-nav">
        <div
          className="float-left flex flex-col items-center w-16 h-screen overflow-hidden text-gray-400 bg-gray-900 rounded">
          <a className="flex items-center justify-center mt-3" href="/dashboard">
